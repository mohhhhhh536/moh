...
#
# Uploads only the seven files this change touches. config/settings_data.json
# is deliberately not among them, so your theme-editor settings — colours,
# fonts, logo, homepage — are left exactly as they are.
#
